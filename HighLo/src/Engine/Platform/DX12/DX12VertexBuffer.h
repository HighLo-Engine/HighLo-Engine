...
namespace highlo
{
	...
	public:
		...
		DX12VertexBuffer(void *data, uint32 size, VertexBufferUsage usage = VertexBufferUsage::Static);
		DX12VertexBuffer(uint32 size, VertexBufferUsage usage = VertexBufferUsage::Dynamic);
