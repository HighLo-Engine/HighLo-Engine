...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><vec2 key=\"test\"><x>20.2</x><y>10.5</y></vec2></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><vec3 key=\"test\"><x>20.2</x><y>10.5</y><z>23.5</z></vec3></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><vec4 key=\"test\"><x>20.2</x><y>10.5</y><z>23.5</z><w>11.5</w></vec4></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><mat2 key=\"test\"><m00>20.2</m00><m01>10.5</m01><m10>23.5</m10><m11>11.5</m11></mat2></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><mat3 key=\"test\"><m00>20.2</m00><m01>10.5</m01><m02>23.5</m02><m10>11.5</m10><m11>534.5</m11><m12>234.5</m12><m20>12.5</m20><m21>45.7</m21><m22>42.4</m22></mat3></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><mat4 key=\"test\"><m00>20.2</m00><m01>10.5</m01><m02>23.5</m02><m03>11.5</m03><m10>534.5</m10><m11>234.5</m11><m12>12.5</m12><m13>45.7</m13><m20>42.4</m20><m21>47.2</m21><m22>55.4</m22><m23>48.4</m23><m30>32</m30><m31>15.1</m31><m32>499.1</m32><m33>22.5</m33></mat4></HighLo>";
...
TEST_F(XMLWriteParserTests, XMLParser_Write_quat)
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><quat key=\"test\"><w>20.2</w><x>10.5</x><y>23.1</y><z>11.5</z></quat></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap><vec2 key=\"object0\"><x>2.5</x><y>2</y></vec2><vec2 key=\"object1\"><x>6.3</x><y>4.5</y></vec2><vec2 key=\"object2\"><x>23</x><y>9.5</y></vec2></arraymap></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><vec2 key=\"object0\"><x>2.5</x><y>2</y></vec2><vec2 key=\"object1\"><x>6.3</x><y>4.5</y></vec2><vec2 key=\"object2\"><x>23</x><y>9.5</y></vec2></arraymap></HighLo>";
	std::vector<glm::vec2> arr;
	arr.push_back({ 2.5f, 2.0f });
	arr.push_back({ 6.3f, 4.5f });
	arr.push_back({ 23.0f, 9.5f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap><vec3 key=\"object0\"><x>2.5</x><y>2</y><z>2.9</z></vec3><vec3 key=\"object1\"><x>6.3</x><y>4.5</y><z>2</z></vec3><vec3 key=\"object2\"><x>23</x><y>9</y><z>5</z></vec3></arraymap></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><vec3 key=\"object0\"><x>2.5</x><y>2</y><z>2.9</z></vec3><vec3 key=\"object1\"><x>6.3</x><y>4.5</y><z>2</z></vec3><vec3 key=\"object2\"><x>23</x><y>9</y><z>5</z></vec3></arraymap></HighLo>";
	std::vector<glm::vec3> arr;
	arr.push_back({ 2.5f, 2.0f, 2.9f });
	arr.push_back({ 6.3f, 4.5f, 2.0f });
	arr.push_back({ 23.0f, 9.0f, 5.0f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap><vec4 key=\"object0\"><x>2.5</x><y>2</y><z>2.9</z><w>6</w></vec4><vec4 key=\"object1\"><x>6.3</x><y>4.5</y><z>2</z><w>7.5</w></vec4><vec4 key=\"object2\"><x>23</x><y>9.5</y><z>5.5</z><w>1.5</w></vec4></arraymap></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><vec4 key=\"object0\"><x>2.5</x><y>2</y><z>2.9</z><w>6</w></vec4><vec4 key=\"object1\"><x>6.3</x><y>4.5</y><z>2</z><w>7.5</w></vec4><vec4 key=\"object2\"><x>23</x><y>9.5</y><z>5.5</z><w>1.5</w></vec4></arraymap></HighLo>";
	std::vector<glm::vec4> arr;
	arr.push_back({ 2.5f, 2.0f, 2.9f, 6.0f });
	arr.push_back({ 6.3f, 4.5f, 2.0f, 7.5f });
	arr.push_back({ 23.0f, 9.5f, 5.5f, 1.5f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap><mat2 key=\"object0\"><m00>0</m00><m01>0</m01><m10>0</m10><m11>0</m11></mat2><mat2 key=\"object1\"><m00>1</m00><m01>0</m01><m10>0</m10><m11>1</m11></mat2><mat2 key=\"object2\"><m00>23</m00><m01>9</m01><m10>5.5</m10><m11>1.5</m11></mat2></arraymap></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><mat2 key=\"object0\"><m00>0</m00><m01>0</m01><m10>0</m10><m11>0</m11></mat2><mat2 key=\"object1\"><m00>1</m00><m01>0</m01><m10>0</m10><m11>1</m11></mat2><mat2 key=\"object2\"><m00>23</m00><m01>9</m01><m10>5.5</m10><m11>1.5</m11></mat2></arraymap></HighLo>";
	std::vector<glm::mat2> arr;
	arr.push_back(glm::mat2(0.0f));
	arr.push_back(glm::mat2(1.0f));
	arr.push_back({ 23.0f, 9.0f, 5.5f, 1.5f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><mat3 key=\"object0\"><m00>0</m00><m01>0</m01><m02>0</m02><m10>0</m10><m11>0</m11><m12>0</m12><m20>0</m20><m21>0</m21><m22>0</m22></mat3><mat3 key=\"object1\"><m00>1</m00><m01>0</m01><m02>0</m02><m10>0</m10><m11>1</m11><m12>0</m12><m20>0</m20><m21>0</m21><m22>1</m22></mat3><mat3 key=\"object2\"><m00>23</m00><m01>9</m01><m02>5.5</m02><m10>1.5</m10><m11>6</m11><m12>1</m12><m20>7.5</m20><m21>0</m21><m22>4.5</m22></mat3></arraymap></HighLo>";
	std::vector<glm::mat3> arr;
	arr.push_back(glm::mat3(0.0f));
	arr.push_back(glm::mat3(1.0f));
	arr.push_back({ 23.0f, 9.0f, 5.5f, 1.5f, 6.0f, 1.0f, 7.5f, 0.0f, 4.5f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><mat4 key=\"object0\"><m00>0</m00><m01>0</m01><m02>0</m02><m03>0</m03><m10>0</m10><m11>0</m11><m12>0</m12><m13>0</m13><m20>0</m20><m21>0</m21><m22>0</m22><m23>0</m23><m30>0</m30><m31>0</m31><m32>0</m32><m33>0</m33></mat4><mat4 key=\"object1\"><m00>1</m00><m01>0</m01><m02>0</m02><m03>0</m03><m10>0</m10><m11>1</m11><m12>0</m12><m13>0</m13><m20>0</m20><m21>0</m21><m22>1</m22><m23>0</m23><m30>0</m30><m31>0</m31><m32>0</m32><m33>1</m33></mat4><mat4 key=\"object2\"><m00>23</m00><m01>9</m01><m02>5.5</m02><m03>1.5</m03><m10>6</m10><m11>1</m11><m12>7.5</m12><m13>0</m13><m20>4.5</m20><m21>10.5</m21><m22>1.1</m22><m23>5.32</m23><m30>3.2</m30><m31>1.5</m31><m32>5.3</m32><m33>4.8</m33></mat4></arraymap></HighLo>";
	std::vector<glm::mat4> arr;
	arr.push_back(glm::mat4(0.0f));
	arr.push_back(glm::mat4(1.0f));
	arr.push_back({ 23.0f, 9.0f, 5.5f, 1.5f, 6.0f, 1.0f, 7.5f, 0.0f, 4.5f, 10.5f, 1.1f, 5.32f, 3.2f, 1.5f, 5.3f, 4.8f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap><quat key=\"object0\"><w>0</w><x>1</x><y>1</y><z>1</z></quat><quat key=\"object1\"><w>1</w><x>0</x><y>0</y><z>0</z></quat><quat key=\"object2\"><w>23</w><x>9</x><y>5.5</y><z>1.5</z></quat></arraymap></HighLo>";
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><arraymap key=\"arrayKeys\"><quat key=\"object0\"><w>0</w><x>1</x><y>1</y><z>1</z></quat><quat key=\"object1\"><w>1</w><x>0</x><y>0</y><z>0</z></quat><quat key=\"object2\"><w>23</w><x>9</x><y>5.5</y><z>1.5</z></quat></arraymap></HighLo>";
	std::vector<glm::quat> arr;
	arr.push_back({ 0.0f, 1.0f, 1.0f, 1.0f });
	arr.push_back({ 1.0f, 0.0f, 0.0f, 0.0f });
	arr.push_back({ 23.0f, 9.0f, 5.5f, 1.5f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><array><vec2><x>1.5</x><y>6</y></vec2><vec2><x>2.5</x><y>1</y></vec2><vec2><x>1</x><y>0</y></vec2></array></HighLo>";
	std::vector<glm::vec2> arr;
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><array><vec3><x>1.5</x><y>6</y><z>5.3</z></vec3><vec3><x>2.5</x><y>1</y><z>5.8</z></vec3><vec3><x>1</x><y>0</y><z>5.5</z></vec3></array></HighLo>";
	std::vector<glm::vec3> arr;
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><array><vec4><x>1.5</x><y>6</y><z>5.3</z><w>2.7</w></vec4><vec4><x>2.5</x><y>1</y><z>5.8</z><w>2.9</w></vec4><vec4><x>1</x><y>0</y><z>5.5</z><w>2.5</w></vec4></array></HighLo>";
	std::vector<glm::vec4> arr;
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><array><mat2><m00>1.5</m00><m01>6</m01><m10>5.3</m10><m11>2.7</m11></mat2><mat2><m00>2.5</m00><m01>1</m01><m10>5.8</m10><m11>2.9</m11></mat2><mat2><m00>1</m00><m01>0</m01><m10>5.5</m10><m11>2.5</m11></mat2></array></HighLo>";
	std::vector<glm::mat2> arr;
	arr.push_back({ 1.5f, 6.0f, 5.3f, 2.7f });
	arr.push_back({ 2.5f, 1.0f, 5.8f, 2.9f });
	arr.push_back({ 1.0f, 0.0f, 5.5f, 2.5f });
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><array><mat3><m00>1.5</m00><m01>6</m01><m02>5.3</m02><m10>2.7</m10><m11>142</m11><m12>155</m12><m20>231</m20><m21>1.753</m21><m22>3571.05</m22></mat3><mat3><m00>2.5</m00><m01>1</m01><m02>5.8</m02><m10>2.9</m10><m11>15</m11><m12>152</m12><m20>7451</m20><m21>175</m21><m22>1573.03</m22></mat3><mat3><m00>1</m00><m01>0</m01><m02>5.5</m02><m10>2.5</m10><m11>1.2</m11><m12>165</m12><m20>861</m20><m21>341</m21><m22>1375.75</m22></mat3></array></HighLo>";
	std::vector<glm::mat3> arr;
...
{
	HLString expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><HighLo><array><quat><w>1.5</w><x>6</x><y>5.3</y><z>2.7</z></quat><quat><w>164.5</w><x>326.5</x><y>235.3</y><z>32</z></quat><quat><w>14.5</w><x>32.5</x><y>23.53</y><z>3.2</z></quat></array></HighLo>";
	std::vector<glm::quat> arr;
	arr.push_back({ 1.5f, 6.0f, 5.3f, 2.7f });
