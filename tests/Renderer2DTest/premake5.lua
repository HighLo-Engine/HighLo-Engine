project "Renderer2DTest"
	...
	postbuildcommands
	{
		...
		("{COPY} %{wks.location}HighLo/vendor/openssl/lib/libcrypto-3-x64.dll %{wks.location}tests/Renderer2DTest/bin/" .. outputdir .. "/Renderer2DTest/libcrypto-3-x64.dll*"),
		("{COPY} %{wks.location}HighLo/vendor/openssl/lib/libssl-3-x64.dll %{wks.location}tests/Renderer2DTest/bin/" .. outputdir .. "/Renderer2DTest/libssl-3-x64.dll*"),
