...
namespace highlo
{
	...
	void Translations::Init()
	{
		...
		german.AddText("animation-timeline-next-frame-btn-tooltip", u8"N�chstes Bild\n\nZum n�chsten Bild springen");
		...
		german.AddText("asset-browser-next-dir-btn-tooltip", u8"N�chstes Verzeichnis\n\nSpring zum n�chsten Verzeichnis, falls vorher zur�ck gegangen wurde");
		...
		german.AddText("asset-browser-right-click-menu-paste", u8"Einf�gen");
		...
		german.AddText("asset-browser-item-delete", u8"Asset l�schen");
		...
		german.AddText("scene-hierarchy-right-click-menu-new-cube", u8"W�rfel");
		...
		german.AddText("object-properties-reset-component", u8"Komponent zur�cksetzen");
		...
		german.AddText("object-properties-camera-component-orthographic-size", u8"Orthgrafische Gr��e");
		...
		german.AddText("object-properties-light-component-intensity", u8"Intensit�t");
		german.AddText("object-properties-light-component-radius", "Radius");
		german.AddText("object-properties-light-component-falloff", u8"�bergang");
		...
		german.AddText("object-properties-light-component-source-size", u8"Quellgr��e");
		...
		Translation english("English", "en-EN");
