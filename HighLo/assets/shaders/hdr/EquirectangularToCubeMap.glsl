...
void main()
{
	vec3 cubeTextureCoord = GetCubeMapTexCoord(vec2(imageSize(o_Cubemap)));
	
	// Got from: https://en.wikipedia.org/wiki/Spherical_coordinate_system#Cartesian_coordinates
