project "Renderer3DDemo"
	...
	postbuildcommands
	{
		("{COPY} %{wks.location}HighLo/bin/" .. outputdir .. "/HighLo/HighLo.dll %{wks.location}demos/Renderer3DDemo/bin/" .. outputdir .. "/Renderer3DDemo/HighLo.dll*"),
